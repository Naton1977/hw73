...
public class PostService {
    ...
    public List<Integer> selectDistinctPostCategoryId() {
        return service.selectDistinctPostCategoryId();
    }

    public List<PostCategory> selectUsingPostCategories(List<Integer> categoryID) {
        return service.selectUsingPostCategories(categoryID);
    }
}
